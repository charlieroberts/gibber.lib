  ...
  var I = Gibber.Environment.Interface = {
    ...
    initializers : {
      Accelerometer : function( widget, props ) {
        var mappingProperties = {
          x : { min:0, max:1, output:LINEAR, wrap:false, timescale:'interface' },
          y : { min:0, max:1, output:LINEAR, wrap:false, timescale:'interface' },
          z : { min:0, max:1, output:LINEAR, wrap:false, timescale:'interface' }
        }
      ...
      MultiSlider : function( widget, props ) {
        var mappingProperties = {
          value : { min:0, max:1, output:LINEAR, wrap:false, timescale:'interface' },
        }
